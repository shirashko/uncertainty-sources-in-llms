...
def plot_multi_model_geometric_analysis(model_configs, output_dir="null_space_detection"):
    """
...
if __name__ == "__main__":
    CONFIGS = [
        ("results/gpt2_multi_layer/multi_layer_metrics.csv",
         "GPT-2 Small"),
        ("results/gemma-2-2b_multi_layer/multi_layer_metrics.csv",
         "Gemma-2-2b"),
        ("results/Llama-3.2-1B_multi_layer/multi_layer_metrics.csv",
         "Llama-3.2-1B")
    ]
